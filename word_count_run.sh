...
hdfs dfs -rm -r $2
hadoop jar /usr/local/hadoop/share/hadoop/tools/lib/hadoop-streaming-3.2.0.jar -mapper 'python3 app/WordCountMapper.py' \
  -reducer 'python3 app/WordCountReducer.py' -input $1 -output $2
